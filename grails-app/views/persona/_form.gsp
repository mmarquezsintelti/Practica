...
<div class="fieldcontain">
     <label for="pais">
         ...
         <span class="required-indicatior">*</span>
     </label>
    <g:select id="pais" name="pais.id" from="${org.javamexico.practica.Pais.list()}" optionKey="id" required=""
         noSelection="['':'Selecciona un pais']"
